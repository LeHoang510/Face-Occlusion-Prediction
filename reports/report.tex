...
The development run reaches its best validation score at epoch~8 (Table~\ref{tab:baselines}); this configuration is reused for the full-data retraining that produces our leaderboard submission.

\section*{Results}
\begin{table}[h]
\centering
\caption{Best validation scores during model selection (90/10 split; lower is better).}
\label{tab:baselines}
\small
\begin{tabular}{@{}lcccc@{}}
\toprule
